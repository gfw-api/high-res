...
The High Resolution WMS microservice is built using [Node.js](https://nodejs.org/en/), and can be executed either natively or using Docker, each of which has its own set of requirements.
...
```
git clone https://github.com/gfw-api/high-res.git && cd high-res
```
